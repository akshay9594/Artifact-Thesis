...
void transf(double tmor[], double tx[])
{
	...
	#pragma cetus parallel 
	#pragma omp parallel for if(((-1+nelt)<=2399)) private(col, col_0, col_1, i, i_0, i_1, i_10, i_11, i_12, i_2, i_3, i_4, i_5, i_6, i_7, i_8, i_9, ie, iface, ig, ig1, ig2, ig3, ig4, ije1, ije2, il, il1, il2, il3, il4, j, nnje, tmp, x, y, z)schedule(guided)
	for (ie=0; ie<nelt; ie ++ )
	{
