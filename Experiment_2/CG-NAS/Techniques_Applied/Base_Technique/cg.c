...
int main(int argc, char * argv[])
{
	...
	print_results("CG", Class, 75000, 0, 0, 75, t, mflops, "          floating point", verified, "3.3.1", "19 Nov 2023", "gcc", "$(CC)", "-lm", "-I../common", "-g -Wall -O3 -fopenmp -mcmodel=large", "-g -O3 -fopenmp -mcmodel=large", "randdp");
	/* --------------------------------------------------------------------- */
	/* More timers */
	/* --------------------------------------------------------------------- */
	if (timeron)
